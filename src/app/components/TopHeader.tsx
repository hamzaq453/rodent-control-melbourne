    ...
    <div className="bg-[#2C6EA5] text-white py-2">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row justify-between items-center space-y-2 sm:space-y-0">
          {/* Service Hours - Hidden on mobile */}
          ...
          <div className="flex items-center space-x-4 sm:space-x-6 sm:ml-auto">
            ...
            <div className="flex items-center space-x-2">
              ...
              <a 
                href="tel:0466660066" 
                className="text-xs sm:text-sm font-medium hover:text-[#9AC3E4] transition-colors duration-200 whitespace-nowrap"
              >
                0466660066
              </a>
            </div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <a 
                ...
                className="text-xs sm:text-sm font-medium hover:text-[#9AC3E4] transition-colors duration-200 break-all sm:break-normal"
              >
