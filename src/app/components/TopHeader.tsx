      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row justify-between items-center space-y-2 sm:space-y-0">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm font-medium">24 hours service | Open 7 Days a Week</span>
          </div>
          ...
          <div className="flex items-center space-x-2">
            ...
            <a 
              href="tel:0466660066" 
              className="text-sm font-medium hover:text-[#9AC3E4] transition-colors duration-200"
            >
              0466660066
            </a>
          </div>
